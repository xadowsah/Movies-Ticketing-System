		...
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3 style="color:black; font-family:serif; font-size:30px; font-weight:600;" class="text-center">BOOKING HISTORY</h3>
				...
				else
				{
					...
					<p style="color: white; font-size:18px; font-family:serif;">Once you start booking movie tickets with this account, you'll be able to see all the booking history.</p>
					<?php
				}
				?>
					</div>			
